...
select
    ...
    round((oa.total_profit_amount / nullif(oa.total_sale_amount, 0)) * 100, 2) as profit_margin_pct,
    oa.avg_item_price,
    ...
    round(extract(epoch from (o.shipped_at - o.created_at)) / 3600, 2) as hours_to_ship,
    round(extract(epoch from (o.delivered_at - o.shipped_at)) / 3600, 2) as hours_in_transit,
    round(extract(epoch from (o.delivered_at - o.created_at)) / 3600, 2) as hours_to_deliver,
