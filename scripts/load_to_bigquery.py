...
def read_table_from_postgres(table_name):
    ...
    if table_name not in TABLE_MAPPINGS:
        raise ValueError(f"Table '{table_name}' not found in mappings. Available tables: {list(TABLE_MAPPINGS.keys())}")
...
def main():
    ...
    parser.add_argument('--table', required=True, help=f'Table name to load. Options: {list(TABLE_MAPPINGS.keys())}')
    parser.add_argument('--mode', default='WRITE_TRUNCATE', 
